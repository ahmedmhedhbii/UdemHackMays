...
Revision ID: cfec8b71bc4e
Revises: 
Create Date: 2025-03-09 09:59:42.250477
...
def upgrade():
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('doctor_id', sa.Uuid(), nullable=False),
    sa.Column('type', sa.Enum('message', 'consultation', 'analysis', name='notificationtype', create_constraint=True), nullable=True),
