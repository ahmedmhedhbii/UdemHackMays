...
Revision ID: c0797ca226ce
Revises: 1a31ce608336
Create Date: 2025-03-08 23:37:52.387519
...
def upgrade():
    ...
    op.add_column('user', sa.Column('role', sa.Enum('doctor', 'patient', 'admin', name='userrole'), nullable=False))
